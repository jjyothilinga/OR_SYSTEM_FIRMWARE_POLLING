...
#define DISABLE_RB0_INTERRUPT()		INTCONbits.INT0IE = 0
#define ENABLE_RB0_INTERRUPT()		INTCONbits.INT0IE = 1

#define DISABLE_RB1_INTERRUPT()		INTCON3bits.INT1IE = 0
#define ENABLE_RB1_INTERRUPT()		INTCON3bits.INT1IE = 1
